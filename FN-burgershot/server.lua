...
QBCore.Functions.CreateCallback('FN-burgershot:server:temfaca', function(source, cb)
    local src = source
    local player = QBCore.Functions.GetPlayer(src)

    local item1 = player.Functions.GetItemByName("faca_cozinha")
...
RegisterServerEvent('FN-burgershot:server:payment', function()
